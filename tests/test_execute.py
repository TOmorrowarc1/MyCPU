    ...
    def build(
        ...
        vectors = [
            ...
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.RS2,
             BranchType.NO_BRANCH, Bits(32)(0x1004),
            ...
            (ALUOp.SUB, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.RS2,
             BranchType.BEQ, Bits(32)(0x1008),
             Bits(32)(0x1000), Bits(32)(10), Bits(32)(20), Bits(32)(8),
             Bits(32)(0), Bits(32)(0), Bits(32)(0xFFFFFFFE)),  # 10-20=-10≠0，BEQ条件不成立
             
            # Case 18: BNE (相等分支，不跳转)
            (ALUOp.SUB, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.RS2,
             BranchType.BNE, Bits(32)(0x1008),
             Bits(32)(0x1000), Bits(32)(10), Bits(32)(10), Bits(32)(8),
             Bits(32)(0), Bits(32)(0), Bits(32)(0)),  # 10-10=0，BNE条件不成立
             
            # Case 19: BLT (不小于分支，不跳转)
            (ALUOp.SLT, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.RS2,
             BranchType.BLT, Bits(32)(0x1008),
             Bits(32)(0x1000), Bits(32)(10), Bits(32)(5), Bits(32)(8),
             Bits(32)(0), Bits(32)(0), Bits(32)(0)),  # 10>=5，BLT条件不成立
             
            # Case 20: BGE (小于分支，不跳转)
            (ALUOp.SLTU, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.RS2,
             BranchType.BGE, Bits(32)(0x1008),
             Bits(32)(0x1000), Bits(32)(5), Bits(32)(10), Bits(32)(8),
             Bits(32)(0), Bits(32)(0), Bits(32)(1)),  # 5<10，BGE条件不成立
             
            # Case 21: BLTU (无符号不小于分支，不跳转)
            (ALUOp.SLTU, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.RS2,
             BranchType.BLTU, Bits(32)(0x1008),
             Bits(32)(0x1000), Bits(32)(10), Bits(32)(5), Bits(32)(8),
             Bits(32)(0), Bits(32)(0), Bits(32)(0)),  # 10>=5，BLTU条件不成立
             
            # Case 22: BGEU (无符号小于分支，不跳转)
            (ALUOp.SLTU, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.RS2,
             BranchType.BGEU, Bits(32)(0x1008),
             Bits(32)(0x1000), Bits(32)(5), Bits(32)(10), Bits(32)(8),
             Bits(32)(0), Bits(32)(0), Bits(32)(1)),  # 5<10，BGEU条件不成立
             
            # --- Store 指令测试 ---
            # Case 23: SW (Store Word) - 存储数据到地址0x1000
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1004),
             Bits(32)(0x1000), Bits(32)(0x1000), Bits(32)(0x12345678), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1004)),  # 地址=0x1000, 数据=0x12345678
             
            # Case 24: SW (Store Word) - 存储数据到地址0x1004
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1008),
             Bits(32)(0x1004), Bits(32)(0x1004), Bits(32)(0xABCDEF00), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1008)),  # 地址=0x1004, 数据=0xABCDEF00
             
            # Case 25: SW (Store Word) - 存储数据到地址0x1008
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x100C),
             Bits(32)(0x1008), Bits(32)(0x1008), Bits(32)(0x11223344), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x100C)),  # 地址=0x1008, 数据=0x11223344
             
            # --- Load 指令测试 ---
            # Case 26: LW (Load Word) - 从地址0x1000加载数据
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1004),
             Bits(32)(0x1000), Bits(32)(0x1000), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1004)),  # 地址=0x1000, 预期加载0x12345678
             
            # Case 27: LW (Load Word) - 从地址0x1004加载数据
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1008),
             Bits(32)(0x1004), Bits(32)(0x1004), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1008)),  # 地址=0x1004, 预期加载0xABCDEF00
             
            # Case 28: LW (Load Word) - 从地址0x1008加载数据
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x100C),
             Bits(32)(0x1008), Bits(32)(0x1008), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x100C)),  # 地址=0x1008, 预期加载0x11223344
             
            # --- 地址对齐测试 ---
            # Case 29: SW (Store Word) - 未对齐地址访问
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1004),
             Bits(32)(0x1000), Bits(32)(0x1001), Bits(32)(0x55555555), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1004)),  # 未对齐地址=0x1001
             
            # Case 30: LW (Load Word) - 未对齐地址访问
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1004),
             Bits(32)(0x1000), Bits(32)(0x1003), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1004)),  # 未对齐地址=0x1003
             
            # --- 不同宽度的Store指令测试 ---
            # Case 31: SH (Store Half) - 存储半字到地址0x1010
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1014),
             Bits(32)(0x1010), Bits(32)(0x1010), Bits(32)(0xABCD), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1014)),  # 地址=0x1010, 数据=0xABCD
             
            # Case 32: SB (Store Byte) - 存储字节到地址0x1011
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1014),
             Bits(32)(0x1010), Bits(32)(0x1011), Bits(32)(0xEF), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1014)),  # 地址=0x1011, 数据=0xEF
             
            # --- 不同宽度的Load指令测试 ---
            # Case 33: LH (Load Half) - 从地址0x1010加载半字（有符号）
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1014),
             Bits(32)(0x1010), Bits(32)(0x1010), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1014)),  # 地址=0x1010, 预期加载0xABCD
             
            # Case 34: LHU (Load Half Unsigned) - 从地址0x1010加载半字（无符号）
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1014),
             Bits(32)(0x1010), Bits(32)(0x1010), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1014)),  # 地址=0x1010, 预期加载0x0000ABCD
             
            # Case 35: LB (Load Byte) - 从地址0x1011加载字节（有符号）
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1014),
             Bits(32)(0x1010), Bits(32)(0x1011), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1014)),  # 地址=0x1011, 预期加载0xFFFFFFEF
             
            # Case 36: LBU (Load Byte Unsigned) - 从地址0x1011加载字节（无符号）
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1014),
             Bits(32)(0x1010), Bits(32)(0x1011), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1014)),  # 地址=0x1011, 预期加载0x000000EF
             
            # --- 混合宽度测试 ---
            # Case 37: SW + SH + SB - 连续存储不同宽度的数据
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1020),
             Bits(32)(0x1020), Bits(32)(0x12345678), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1024)),  # 地址=0x1020, 数据=0x12345678
             
            # Case 38: 从0x1020读取字，验证之前存储的数据
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1024),
             Bits(32)(0x1020), Bits(32)(0x1020), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1024)),  # 地址=0x1020, 预期加载0x12345678
             
            # --- 半字和字节未对齐测试 ---
            # Case 39: SH (Store Half) - 未对齐地址访问
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1024),
             Bits(32)(0x1020), Bits(32)(0x1021), Bits(32)(0x1234), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1024)),  # 未对齐地址=0x1021
             
            # Case 40: LH (Load Half) - 未对齐地址访问
            (ALUOp.ADD, Rs1Sel.RS1, Rs2Sel.RS2, Op1Sel.RS1, Op2Sel.CONST_4,
             BranchType.NO_BRANCH, Bits(32)(0x1024),
             Bits(32)(0x1020), Bits(32)(0x1023), Bits(32)(0), Bits(32)(0),
             Bits(32)(0), Bits(32)(0), Bits(32)(0x1024)),  # 未对齐地址=0x1023
        ]
        ...
        with Condition(idx >= UInt(32)(29) & idx < UInt(32)(31)):  # Cases 29-30: 未对齐访问测试
...
class Sink(Module):
    ...
    @module.combinational
    def build(self, dut: Module, mem_module: Module, driver_cnt, driver_expected):
        # 创建一个虚拟的SRAM用于测试
        ...
        class MockSRAM:
            ...
            def build(self, we, wdata, addr, re):
                # 记录SRAM操作
                log("SRAM: we={} re={} addr=0x{:x} wdata=0x{:x}", we, re, addr, wdata)
                ...
                with Condition(we & addr_aligned & addr_in_range):
                    if self.mem_width == MemWidth.WORD:
                        ...
                        log("SRAM: Write WORD addr=0x{:x} data=0x{:x}", word_addr << 2, wdata)
                    elif self.mem_width == MemWidth.HALF:
                        # 半字写操作
                        old_data = self.data[word_addr]
                        if byte_offset == Bits(2)(0):
                            # 写入低16位
                            new_data = Bits(32)((old_data & 0xFFFF0000) | (wdata & 0x0000FFFF))
                        else:
                            # 写入高16位
                            new_data = Bits(32)((old_data & 0x0000FFFF) | ((wdata & 0x0000FFFF) << 16))
                        self.data[word_addr] = new_data
                        log("SRAM: Write HALF addr=0x{:x} data=0x{:x} (byte_offset={})", word_addr << 2, wdata, byte_offset)
                    else:  # MemWidth.BYTE
                        # 字节写操作
                        old_data = self.data[word_addr]
                        if byte_offset == Bits(2)(0):
                            # 写入字节0
                            new_data = Bits(32)((old_data & 0xFFFFFF00) | (wdata & 0x000000FF))
                        elif byte_offset == Bits(2)(1):
                            # 写入字节1
                            new_data = Bits(32)((old_data & 0xFFFF00FF) | ((wdata & 0x000000FF) << 8))
                        elif byte_offset == Bits(2)(2):
                            # 写入字节2
                            new_data = Bits(32)((old_data & 0xFF00FFFF) | ((wdata & 0x000000FF) << 16))
                        else:
                            # 写入字节3
                            new_data = Bits(32)((old_data & 0x00FFFFFF) | ((wdata & 0x000000FF) << 24))
                        self.data[word_addr] = new_data
                        log("SRAM: Write BYTE addr=0x{:x} data=0x{:x} (byte_offset={})", word_addr << 2, wdata, byte_offset)
                ...
                with Condition(re & addr_aligned & addr_in_range):
                    if self.mem_width == MemWidth.WORD:
                        ...
                        log("SRAM: Read WORD addr=0x{:x} data=0x{:x}", word_addr << 2, self.data[word_addr])
                    elif self.mem_width == MemWidth.HALF:
                        # 半字读操作
                        ...
                        if self.mem_unsigned == MemSign.UNSIGNED:
                            ...
                            self.dout[0] = Bits(32)((Bits(16)(sign_bit).repeat(16) << 16) | half_data)
                        
                        sram_dout[0] = self.dout[0]  # 更新输出
                        log("SRAM: Read HALF addr=0x{:x} data=0x{:x} (byte_offset={}, signed={})",
                            word_addr << 2, self.dout[0], byte_offset, self.mem_unsigned == MemSign.SIGNED)
                    else:  # MemWidth.BYTE
                        # 字节读操作
                        word_data = self.data[word_addr]
                        if byte_offset == Bits(2)(0):
                        ...
                        if self.mem_unsigned == MemSign.UNSIGNED:
                            ...
                            self.dout[0] = Bits(32)((Bits(8)(sign_bit).repeat(24) << 8) | byte_data)
                        
                        sram_dout[0] = self.dout[0]  # 更新输出
                        log("SRAM: Read BYTE addr=0x{:x} data=0x{:x} (byte_offset={}, signed={})",
                            word_addr << 2, self.dout[0], byte_offset, self.mem_unsigned == MemSign.SIGNED)
                
                # 地址未对齐警告
                with Condition(we | re):
                    with Condition(~addr_aligned):
                        log("SRAM: Warning - Unaligned access addr=0x{:x} (required {}-byte alignment)",
                            addr, access_size)
...
def check(raw_output):
    ...
    expected_results = [
        ...
        0xFFFFFFFE,  # Case 17: BEQ (10-20=-10≠0，BEQ条件不成立)
        0x00000000,  # Case 18: BNE (10-10=0，BNE条件不成立)
        0x00000000,  # Case 19: BLT (10>=5，BLT条件不成立)
        0x00000001,  # Case 20: BGE (5<10，BGE条件不成立)
        0x00000000,  # Case 21: BLTU (10>=5，BLTU条件不成立)
        0x00000001,  # Case 22: BGEU (5<10，BGEU条件不成立)
        0x00001000,  # Case 23: SW (地址=0x1000)
        0x00001004,  # Case 24: SW (地址=0x1004)
        0x00001008,  # Case 25: SW (地址=0x1008)
        0x00001000,  # Case 26: LW (地址=0x1000, 预期加载0x12345678)
        0x00001004,  # Case 27: LW (地址=0x1004, 预期加载0xABCDEF00)
        0x00001008,  # Case 28: LW (地址=0x1008, 预期加载0x11223344)
        0x00001000,  # Case 29: SW (未对齐地址=0x1001)
        0x00001000,  # Case 30: LW (未对齐地址=0x1003)
    ]
    ...
    expected_sram_ops = [
        ...
        ("STORE", 0x1000, 0x12345678),  # Case 23: SW (地址=0x1000, 数据=0x12345678)
        ("STORE", 0x1004, 0xABCDEF00),   # Case 24: SW (地址=0x1004, 数据=0xABCDEF00)
        ("STORE", 0x1008, 0x11223344),   # Case 25: SW (地址=0x1008, 数据=0x11223344)
        ("LOAD", 0x1000, 0x12345678),   # Case 26: LW (地址=0x1000, 预期加载0x12345678)
        ("LOAD", 0x1004, 0xABCDEF00),   # Case 27: LW (地址=0x1004, 预期加载0xABCDEF00)
        ("LOAD", 0x1008, 0x11223344),   # Case 28: LW (地址=0x1008, 预期加载0x11223344)
        ("STORE", 0x1001, 0x55555555),   # Case 29: SW (未对齐地址=0x1001, 数据=0x55555555)
        ("LOAD", 0x1003, None),          # Case 30: LW (未对齐地址=0x1003)
    ]
    ...
    for line in raw_output.split("\n"):
        ...
        # 捕获SRAM写操作
        if "SRAM: Write addr=" in line:
            # 示例行: "SRAM: Write addr=0x1000 data=0x12345678"
            ...
            if addr_match and data_match:
                ...
                sram_ops.append(("STORE", addr, data))
                print(f"  [捕获] SRAM Write: addr=0x{addr:08x}, data=0x{data:08x}")
        
        # 捕获SRAM读操作
        if "SRAM: Read addr=" in line:
            # 示例行: "SRAM: Read addr=0x1000 data=0x12345678"
            addr_match = re.search(r'addr=(0x[0-9a-fA-F]+)', line)
            data_match = re.search(r'data=(0x[0-9a-fA-F]+)', line)
            if addr_match and data_match:
                addr = int(addr_match.group(1), 16)
                data = int(data_match.group(1), 16)
                sram_ops.append(("LOAD", addr, data))
                print(f"  [捕获] SRAM Read: addr=0x{addr:08x}, data=0x{data:08x}")
        ...
        if "SRAM: Warning - Unaligned access" in line:
            ...
            if addr_match:
                ...
                # 检查是Store还是Load操作
                if "we=True" in line:
                    sram_ops.append(("STORE", addr, None))  # 未对齐的Store操作，数据不重要
                    print(f"  [捕获] SRAM Unaligned Store: addr=0x{addr:08x}")
                elif "re=True" in line:
                    sram_ops.append(("LOAD", addr, None))  # 未对齐的Load操作，数据不重要
                    print(f"  [捕获] SRAM Unaligned Load: addr=0x{addr:08x}")
    ...
    if len(branch_types) != len(expected_branch_types):
        print(f"❌ 错误：预期分支类型 {len(expected_branch_types)} 个，实际捕获 {len(branch_types)} 个")
        assert False
    ...
    expected_targets = [target for target in expected_branch_targets if target is not None]
    if len(branch_updates) != len(expected_targets):
        print(f"❌ 错误：预期分支目标更新 {len(expected_targets)} 次，实际更新 {len(branch_updates)} 次")
    ...
    if len(branch_taken) != len(expected_branch_taken):
        print(f"❌ 错误：预期分支跳转状态 {len(expected_branch_taken)} 个，实际捕获 {len(branch_taken)} 个")
        assert False
    
    # 9. 分支跳转状态内容检查
    for i, (exp_taken, act_taken) in enumerate(zip(expected_branch_taken, branch_taken)):
...
if len(sram_ops) != len(expected_sram_filtered):
    print(f"❌ 错误：预期SRAM操作 {len(expected_sram_filtered)} 次，实际操作 {len(sram_ops)} 次")
